...
class PerchBlog_Posts extends PerchAPI_Factory
{
	...
	public $static_fields   = array('postTitle', 'postSlug', 'postDateTime', 'postDescRaw', 'postDescHTML', 'postTags', 'postStatus', 
                                        'authorID', 'authorGivenName', 'authorFamilyName', 'authorEmail', 'authorSlug', 'postURL', 'postAllowComments');
	...
	*/
    ...
    {
        if(isset($data['postDescRaw']) && !isset($data['postDescHTML'])) {
            ...
            $data['postDescHTML'] = (isset($data['postDescHTML']) ? $data['postDescHTML'] : false);
        }
